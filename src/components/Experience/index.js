  ...
  return (
    <section id="experience" className="jobs">
      ...
      <VerticalTimeline>
          ...
          return (
            <React.Fragment key={data.id}>
              <VerticalTimelineElement
                ...
                icon={
                  data.type === "work" ? (
                    <Briefcase aria-label="Work Experience" />
                  ) : (
                    <Book aria-label="Education Experience" />
                  )
                }
              >
        ...
        <VerticalTimelineElement
          iconStyle={{ background: "rgb(153, 0, 0)", color: "#fff" }}
          icon={<HourglassBottom aria-label="End of Timeline" />}
        />
      </VerticalTimeline>
    </section>
  );
