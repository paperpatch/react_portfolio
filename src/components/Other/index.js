  ...
  const projects = {
    other: [
      ...
      },
      {
        ...
        description:
          "Created a back end for a general company's e-commerce site suing Express.js API and Sequelize configurations to interact with a MySQL database. Uses environmental variables and password zero-dependency module.",
